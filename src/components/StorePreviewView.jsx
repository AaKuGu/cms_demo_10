    ...
    {/* Contact section */ }
{
    visibleContact && (
        (visibleContact.email ||
            ...
            <div className="shrink-0 border-t border-[#ECE2D2] bg-white">
                <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
                    <p className="mb-4 text-center font-serif text-lg text-[#241A15] sm:text-xl">
                        Get in touch
                    </p>
...
{/* Socials footer */ }
{
    visibleSocialLinks.length > 0 && (
        <div className="shrink-0 border-t border-[#ECE2D2] bg-[#FBF7F0]/50">
            <div className="mx-auto flex max-w-6xl items-center justify-center gap-3 px-4 py-4 sm:gap-4 sm:py-5">
...
<a
                        key = {`${link.platform}-${index}`}
                                    ...
                                    className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-[#7A1F3D] shadow-sm ring-1 ring-[#ECE2D2] transition duration-200 hover:-translate-y-0.5 hover:bg-[#7A1F3D] hover:text-white hover:shadow-md sm:h-10 sm:w-10"
                                >
